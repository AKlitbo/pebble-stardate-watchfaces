...
module.exports = {
  ...
  manipulator: {
    /**
     * Restores a previously saved selection from the persisted JSON string {lat, lon, label}, or ''.
     */
    set: function(value) {
    ...
    /**
     * Returns the persisted JSON string for the chosen location, or ''.
     */
    get: function() {
  ...
  initialize: function() {
    ...
    // formats a place into "name, admin1, country"
    ...
    // renders the geocoding results - DOM nodes rather than innerHTML to prevent markup injection
    ...
    // runs a geocoding search for the typed query
